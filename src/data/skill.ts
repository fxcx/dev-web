...
export const skills: Skill[] = [
    ...
    { name: "Postgresql", image: "/postgresql-svgrepo-com.svg", width: 80, height: 80 },
    { name: "TypeScript", image: "/ts.png", width: 80, height: 80 },
    { name: "Next js 13", image: "/next.png", width: 80, height: 80 },
    { name: "Python", image: "/python-svgrepo-com.svg", width: 80, height: 80 },
    { name: "Node js", image: "/node-js.png", width: 80, height: 80 },
    { name: "Mongo db", image: "/mongodb-svgrepo-com.svg", width: 80, height: 80 },
    { name: "Docker", image: "/docker.webp", width: 80, height: 80 },
    { name: "Prisma", image: "/light-prisma-svgrepo-com.svg", width: 80, height: 80 },
    { name: "Redis", image: "/redis-svgrepo-com.svg", width: 80, height: 80 },
];
